...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "pyrus.py"
 
        #Name of program
        self.project_name = "Pyrus"
 
        #Project url
        self.project_url = "akathorn.org"
        ...
        #Auhor of program
        self.author_name = "Akathorn"
        self.author_email = "Akathorn@gmail.com"
        self.copyright = "Copyright (c) 2009 Akathorn"
 
        #Description
        self.project_description = "Simple Python game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "resources/images/gvirus.ico"
